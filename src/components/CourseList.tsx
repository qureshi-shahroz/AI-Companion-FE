...
import type { CourseListProps } from "@/hooks/useAIChat";

export const CourseList = ({ goal, duration, courses }: CourseListProps) => {
  return (
    <div className="space-y-6">
      ...
      {/* Courses Grid */}
      <div>
        <h2 className="text-2xl font-bold mb-6 text-foreground">Available Courses</h2>
